...
- Example: for this list [1,4,5,6,1,2,4,5,6,5] the function returns 5 
because it is the only numbers repeated 3 times (the most)
...
def findMostRepeatedNumber(numbers):
    ...
    print("Number %d had been repeated %d item" %(mostRepeatedNumber, maximum))
